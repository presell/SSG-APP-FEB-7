...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: I9SB9T_b3JIt/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__diVE)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__mugVy)}
              role={"img"}
            />
          ),
