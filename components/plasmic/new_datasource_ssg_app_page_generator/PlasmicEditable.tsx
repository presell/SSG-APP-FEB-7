...
import sty from "./PlasmicEditable.module.css"; // plasmic-import: dmMEM1iCmId9/css
    ...
    >
      <div
        className={classNames(
          ...
          "editableText",
          {
            [sty.freeBoxeditEnabled__dzP4OBkRem]: hasVariant(
              $state,
              "editEnabled",
              "editEnabled"
            )
      ...
      <div
        className={classNames(
          ...
          "textEditor",
          {
            [sty.freeBoxeditEnabled__x0V1JBkRem]: hasVariant(
              $state,
              "editEnabled",
              "editEnabled"
            )
      ...
      >
        {(hasVariant($state, "editEnabled", "editEnabled") ? true : false)
          ? renderPlasmicSlot({
              defaultContents: (
                <TextInput
                  className={classNames("__wab_instance", sty.textInput__pGRii)}
                  endIcon={null}
                  startIcon={null}
                />
              ),
